...
class ServiceCategoryController extends Controller
{
    public function store(Request $request) {
        ...
        return redirect()->route('master_service.show', $request->master_service_id);
    }

    public function getTrees(Request $request) {
        if($request->json()) {
            $serviceCategories = ServiceCategory::where('master_service_id', $request->master_service_id)->get();
            $data = [];
