    ...
    <div class="media">
        <div class="media-left">
            <a href="#">
                ...
                @else
                    <img class="media-object" src="{{ asset('default-images/handshake-icon.png')  }}" alt="..." width="64" height="64">
                @endif
            </a>
        </div>
        <div class="media-body">
            <h4 class="media-heading">{{ $masterService->name }}</h4>
            <a href="{{ route('add_service_faq', $masterService->id) }}" class="btn btn-primary">
                        ...
                        <div id="collapse-{{ $counter }}" class="panel-collapse collapse">
                            ...
                            <div class="panel-footer">
                                @if(Auth::user()->user_type_id == 1)
                                    <div class="">
                                        <a class="btn btn-warning btn-sm" href="{{ route('edit_service_faq', $faqService->id) }}" style="margin-right: 3px;">
                                            <i class="fa fa-pencil-square-o"></i> Edit
                                        </a>
                                        <a class="btn btn-danger btn-sm"
                                           href="#"
                                           onclick="setDataId(this)"
                                           data-id="{{ $faqService->id }}"
                                           data-toggle="modal"
                                           data-target="#modal_delete_service_faq">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit"
                            ...
                            data-modal="#modal_delete_service_faq"
