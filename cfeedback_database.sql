...
--
-- Host: localhost
-- Generation Time: Nov 17, 2017 at 11:15 AM
...
(27, '2017_11_16_083941_create_service_categories_table', 20);
...
(1, NULL, 1, 6, 0, 'Test', '58407f9e-1969-49f1-9bcb-22b98b28ae47', '2017-10-29 21:32:48', '2017-11-15 21:58:01'),
(2, 1, 2, 3, 1, 'Test Level 2', NULL, '2017-10-30 01:40:23', '2017-11-15 21:58:01'),
(4, NULL, 7, 10, 0, 'Taste', '58407f9e-1969-49f1-9bcb-22b98b28ae47', '2017-10-30 03:30:26', '2017-11-17 00:56:43'),
(5, 4, 8, 9, 1, 'Saltiness', NULL, '2017-11-01 02:18:08', '2017-11-15 21:58:01'),
(7, 1, 4, 5, 1, 'Test level 2 same level', NULL, '2017-11-01 03:06:33', '2017-11-15 21:58:01'),
(21, NULL, 11, 12, 0, 'Taste', '038a6e90-646f-4c77-904d-5350ab0f7b55', '2017-11-16 01:21:52', '2017-11-17 02:31:09');
...
CREATE TABLE `service_categories` (
  ...
  `depth` int(11) DEFAULT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `master_service_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `service_categories` (`id`, `parent_id`, `lft`, `rgt`, `depth`, `name`, `master_service_id`, `created_at`, `updated_at`) VALUES
(1, NULL, 1, 4, 0, 'Speed', '231e6293-8488-440d-a9a6-13a374a1699f', '2017-11-16 03:35:59', '2017-11-17 02:30:35'),
(3, 1, 2, 3, 1, 'Speed level 2', NULL, '2017-11-17 02:30:34', '2017-11-17 02:30:35'),
(4, NULL, 5, 6, 0, 'Bandwidth', '231e6293-8488-440d-a9a6-13a374a1699f', '2017-11-17 03:06:01', '2017-11-17 03:11:53');
...
ALTER TABLE `service_categories`
  ADD PRIMARY KEY (`id`),
  ADD KEY `service_categories_parent_id_index` (`parent_id`),
  ADD KEY `service_categories_lft_index` (`lft`),
  ADD KEY `service_categories_rgt_index` (`rgt`),
  ADD KEY `service_categories_master_service_id_index` (`master_service_id`);
...
--
ALTER TABLE `service_categories`
  ADD CONSTRAINT `service_categories_master_service_id_foreign` FOREIGN KEY (`master_service_id`) REFERENCES `master_services` (`id`) ON DELETE CASCADE;
